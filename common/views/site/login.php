...
?>
    ...
    <div class="content">
        <!-- BEGIN LOGIN FORM -->
        <form class="login-form" action="<?=\yii\helpers\Url::toRoute('site/login')?>" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="on" placeholder="用户名" name="info[username]" />
            </div>
            <div class="form-group">
    ...
    <div class="copyright"> 2016 &copy; Metronic.  </div>
